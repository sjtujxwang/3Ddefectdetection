...
CBaslerUniversalInstantCamera Camera_t;
CBaslerUniversalCameraEventHandler CameraEventHandler_t; // Or use Camera_t::CameraEventHandler_t
CBaslerUniversalImageEventHandler ImageEventHandler_t; // Or use Camera_t::ImageEventHandler_t
CBaslerUniversalGrabResultPtr GrabResultPtr_t; // Or use Camera_t::GrabResultPtr_t
...
int main(int argc, char* argv[])
{
    ...
    try
    {
        ...
        if (camera.GetSfncVersion() < Sfnc_2_0_0) 
        {
            ...
            camera.RegisterCameraEventHandler(&eventHandler, "EventOverrunEventData", eMyExposureEndEvent, RegistrationMode_ReplaceAll, Cleanup_None);
        }
        else 
        {
